...
const Technology = () => {
  return (
    <div className="bg-black text-white min-h-screen py-12 px-5 sm:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-serif text-gray-600 mb-16 text-center tracking-wide">
          Technology
        </h1>
        ...
        {/* Features Grid */}
        <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-20">
          {[
            {
