...
const Usabout = () => {
  return (
    <div
      className="relative mx-auto w-[90%] max-w-[1400px] text-white overflow-hidden"
      style={{ fontFamily: "var(--head-font)", backgroundColor: "var(--bg)" }}
    >
      {/* ---------- Hero Section ---------- */}
      ...
      {/* ---------- Main Content ---------- */}
      <section className="max-w-7xl mx-auto px-7 sm:px-6 md:px-10 space-y-16 sm:space-y-20 md:space-y-24">
        {/* Row 1 - Company Intro */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p
              className="text-sm sm:text-base text-gray-300 leading-relaxed tracking-wide text-justify"
              style={{ fontFamily: "var(--body-font)" }}
            >
              stands as a symbol of innovation, elegance, and fine craftsmanship
              in the ceramic tile industry. We offer a diverse range of tiles –
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="order-1 md:order-2">
            <h3 className="text-lg sm:text-2xl font-semibold mb-6 leading-relaxed tracking-wide">
              At Breezo, we blend artistry with engineering
            </h3>
            <ul
              ...
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <img
                    ...
                    className="w-5 h-5 mt-1 shrink-0"
                  />
                  <span className="text-sm sm:text-base text-gray-300 leading-relaxed tracking-wide text-justify">
                    {text}
                  </span>
                </li>
              ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <h3
              className="text-lg sm:text-2xl font-semibold mb-6 leading-relaxed tracking-wide text-justify"
              style={{ fontFamily: "var(--head-font)" }}
            >
              We believe tiles do more than cover surfaces — they transform
              spaces:
        ...
        {/* ---------- Vision & Mission ---------- */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10 -mx-3 text-center md:text-left">
          {[
            {
              title: "Our Vision",
              text: "To be a globally recognized leader in ceramics — setting new benchmarks in design, functionality, sustainability, and customer trust.",
            ...
            >
              ...
              <p className="text-gray-300 leading-snug text-sm md:text-base relative z-10 text-justify">
                {item.text}
              </p>
            </div>
          ))}
        ...
        <div className="pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            <div className="overflow-x-auto">
              <table className="text-gray-300 text-sm sm:text-base leading-7 mx-auto border-collapse">
                {[
                  ["Glossy", "Wall Tiles", "20X60CM"],
                  ["Carving", "Floor Tiles", "20X100CM"],
                  ["High Gloss", "GVT/PGVT", "30X45CM"],
        ...
        {/* ---------- Core Values ---------- */}
        <div className="pt-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif mb-12 text-center">
            Our Core Values
          </h1>
